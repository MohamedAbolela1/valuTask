...
public final class FragmentDetailsBinding implements ViewBinding {
  ...
  private FragmentDetailsBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardProduct,
      @NonNull AppCompatImageView imgProduct, @NonNull BackToolbarBinding toolbarDetails,
      @NonNull TextView tvDescription, @NonNull TextView tvPrice,
      @NonNull AppCompatTextView tvRating, @NonNull TextView tvTitle) {
  ...
  public static FragmentDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvRating;
      AppCompatTextView tvRating = ViewBindings.findChildViewById(rootView, id);
      if (tvRating == null) {
        break missingId;
      }
      ...
      return new FragmentDetailsBinding((ConstraintLayout) rootView, cardProduct, imgProduct,
          binding_toolbarDetails, tvDescription, tvPrice, tvRating, tvTitle);
    }
