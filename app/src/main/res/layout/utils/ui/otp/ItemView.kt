...
class ItemView : FrameLayout {
    ...
    private fun generateViews(styles: TypedArray) {
        ...
        hideOTPDrawable = styles.getResourceId(
            ...
            R.drawable.background_label
        )

        defaultOTPDrawable = ResourcesCompat.getColor(context.resources, R.color.transparent, null)

        val barEnabled = styles.getBoolean(R.styleable.OtpTextView_bar_enabled, true)
        ...
        barActiveColor = styles.getColor(
            ...
            ResourcesCompat.getColor(context.resources, R.color.darkGray, null)
        )
        ...
        if (barEnabled) {
            ...
            barViewParams.gravity = Gravity.BOTTOM.or(Gravity.CENTER_VERTICAL)
            if (barMargin != 0f) {
